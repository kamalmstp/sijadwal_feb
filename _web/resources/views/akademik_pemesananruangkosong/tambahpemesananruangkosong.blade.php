    ...
    <div class="col-lg-12 mb-12">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Tambah Data Pemesanan Ruangan Kosong</h6>
        </div>
        <div class="card-body">
            ...
            <hr>
            <form method="POST" action="{{ route('simpanpemesanan_ruangan_kosong')}}" enctype="multipart/form-data" novalidate="novalidate">
                {!! csrf_field() !!} 
