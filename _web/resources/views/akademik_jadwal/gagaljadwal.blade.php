    ...
    <div class="col-lg-12 mb-12">
      ...
      <div class="card shadow mb-4">
        <div class="card-header py-3">
          <h6 class="m-0 font-weight-bold text-primary">Gagal</h6>
        </div>
        <div class="card-body">                    
            ...
            <div class="col-lg-12">              
                @include ('errors.list') {{-- Including error file --}}
                    ...
                    <div class="row">
                        ...
                        <hr/>
                        <h2 style="text-align:center;">" Waktu dan Ruangan Tidak Tersedia "</h2>
                        <h4 style="text-align:center;">Sudah Ada Mata Kuliah Yang Berlangsung di Jam & Ruangan Tersebut</h4>
                        <hr>   
