    ...
    <div class="col-lg-12 mb-12">
      ...
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <hr>
            <form method="POST" action="{{ route('updatetahun_ajaran', $edittahun_ajaran->id_tahunajaran)}}" enctype="multipart/form-data" novalidate="novalidate">
                {!! csrf_field() !!} 
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" tabindex="1" data-placeholder="Pilih Mata Kuliah.." name="semester" class="span8">
                            @if ($edittahun_ajaran->semester == "GENAP")
